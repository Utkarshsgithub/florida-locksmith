...
let taarif2 =
  "My house door was stuck from last 3 months, I've called many people to fix it in these three months, they fixed it but it was just working for 2-3days and again got stuck. So finally I called Floridian Locksmiths, they just took 1 hour to identify the problem and provided me with a permanent solution.";
...
let taarif4 =
  "Services of Floridian Locksmith Company are fast, reliable and really awesome. Really amazed with the quality of their work. Thank You!";
...
function switchTestimonial() {
  testimonial.style.transform = "translateY(200%)";
  if (testimonial_no == 1) {
...
const navbarUl = document.getElementsByClassName("res-ul");
...
button.addEventListener("click", () => {
  if (!menuOpen) {
    ...
    setTimeout(() => {
      navbarUl[0].style.display = "block";
      navbarUl[1].style.display = "block";
    }, 500);
  } else {
    button.classList.remove("open");
    menuOpen = false;
    navbar.style.height = "100px";
    navbarUl[0].style.display = "none";
    navbarUl[1].style.display = "none";
  }
});
